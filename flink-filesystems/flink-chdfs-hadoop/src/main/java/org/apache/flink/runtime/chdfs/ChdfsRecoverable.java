 ...
 */
class ChdfsRecoverable implements CommitRecoverable, ResumeRecoverable {
	 ...
	 */
	ChdfsRecoverable(Path targetFile, Path tempFile, long offset) {
	...
	public String toString() {
		return "ChdfsRecoverable " + tempFile + " @ " + offset + " -> " + targetFile;
	}
}
